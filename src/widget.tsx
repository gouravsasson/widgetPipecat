...
class ReactWidget extends HTMLElement {
    ...
    connectedCallback() {
      ...
      link.rel = 'stylesheet';
      link.href = 'https://widget-aivideo2.vercel.app/style.css'; // Replace with the actual path to your generated CSS file
      ...
      this.root.render(
        <React.StrictMode>
          <WidgetProvider agent_id={agent_id} schema={schema} access_token={access_token}>
            <App />
          </WidgetProvider>
        </React.StrictMode>
      );
